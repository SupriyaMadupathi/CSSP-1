...
#
#
def computer_choose_word(hand, wordList, n):
    """
...
#
def computer_play_hand(hand, wordList, n):
    """
    ...
    while (calculate_hand_length(hand) > 0):
        ...
        display_hand(hand)
        # computer's word
        word = computer_choose_word(hand, wordList, n)
...
def play_game(wordList):
    ...
    hand = []
    while True:
        user_input1 = input("Enter a input c(to play computer) or u(to play by you) ")
        if user_input1 == 'u':
            ...
            if user_input == 'n':
                hand = deal_hand(HAND_SIZE)
                compute_play_hand(hand, word_list, HAND_SIZE)
            elif user_input == 'r':
                computer_play_hand(hand, word_list, HAND_SIZE)
            elif user_input == 'e':
                print("Game Over!")
        else:
